    ...
    <Highlight {...defaultProps} code={text} language={language} theme={theme}>
      {({ className, tokens, getLineProps, getTokenProps }) => (
        <pre
          className={
            className +
            'transition-all w-fit bg-opacity-50 duration-100 p-1 no-scrollbar text-xs md:text-sm border-4 border-opacity-10 border-orange-300 dark:border-blue-700 dark:border-opacity-10'
          }
          style={{
